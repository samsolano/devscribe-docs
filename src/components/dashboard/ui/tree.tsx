...
// Updated CollapseButton component to handle function children
const CollapseButton = forwardRef<
  HTMLButtonElement,
  {
    elements: TreeViewElement[]
    expandAll?: boolean
    children?: React.ReactNode | ((props: { expandedItems: string[] | undefined }) => React.ReactNode)
...
>(({ className, elements, expandAll = false, children, ...props }, ref) => {
  ...
  // Render the children based on whether it's a function or a React node
  const renderChildren = () => {
    if (typeof children === "function") {
      return children({ expandedItems })
    }
    return children
  }
